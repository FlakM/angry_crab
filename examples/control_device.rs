use angry_crab::controller::WgController;
use angry_crab::domain::{
    Identity, IpWithCidr, LocalSettings, Peer, PeerUpdate, WgInstanceUpdateSettings,
};
use angry_crab::{domain, keys};
use anyhow::Result;
